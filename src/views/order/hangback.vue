  ...
  <div class="leavePage">
    ...
    >
      ...
      <el-table-column prop="orderMoney" label="订单金额" align="center"></el-table-column>
       <el-table-column  label="订单欠款" align="center">
        <template slot-scope="scope">
          <el-button type="primary" size="mini">需收</el-button>
           {{ scope.row.orderArrears }}</template>
      </el-table-column>
   ...
   <inHouse :show="showDrawe" @closeInhouse="closeDrawe"></inHouse>
  </div>
</template>
